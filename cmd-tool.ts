...
export default function (pi: ExtensionAPI) {
  pi.registerTool({
    ...
    promptGuidelines: [
      "Use cmd for simple Windows builtins and narrow command-line verification; prefer structured tools for file inspection.",
      "Use cmd codepage=65001 for UTF-8 output or 936 for legacy Chinese output when decoding is incorrect.",
      "Do not use cmd for complex object, JSON, CSV, or mixed-encoding pipelines; use powershell instead.",
    ],
